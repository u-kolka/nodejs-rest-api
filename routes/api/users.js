...
const { signupUser, loginUser, logoutUser, currentUser, updateUser, uploadImage, verifyEmail, repeatSendVerifyEmail,
...
routeUsers.get("/verify/:verificationToken", tryCatchWrapper(verifyEmail));
routeUsers.post("/verify", tryCatchWrapper(repeatSendVerifyEmail));
